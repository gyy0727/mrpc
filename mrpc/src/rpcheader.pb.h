...
inline std::string* RpcHeader::unsafe_arena_release_service_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:rpcheader.RpcHeader.service_name)
...
inline void RpcHeader::unsafe_arena_set_allocated_service_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:rpcheader.RpcHeader.service_name)
}
...
inline std::string* RpcHeader::unsafe_arena_release_method_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:rpcheader.RpcHeader.method_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void RpcHeader::unsafe_arena_set_allocated_method_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:rpcheader.RpcHeader.method_name)
}
